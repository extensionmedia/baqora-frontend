<div class="py-4">
    ...
    <a href="" class="bg-gray-100 rounded-lg hover:bg-gray-200 text-xs px-1 text-red-400"> {{$annonce->category->annonce_category_name}} </a> <i class="text-xs fas fa-angle-right"></i>
